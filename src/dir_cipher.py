...
class DirectoryCipher:
    def __init__(self, key: bytes) -> None:
        """
        :param key: b string object of length 16/24/32 bytes
        """
        self.key = key
    ...
    def pad(data: bytes) -> bytes:
        ...
        :param data: b string data string that is to be padded"""
    ...
    def encrypt_directory(self, data: bytes, iv: bytes) -> bytes:
        ...
        :param data: data for encryption as b string
        :param iv: b string initialization vector 16 bytes of length"""
